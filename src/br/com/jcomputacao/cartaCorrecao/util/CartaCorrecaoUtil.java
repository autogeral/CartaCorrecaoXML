 ...
 *
 */
package br.com.jcomputacao.cartaCorrecao.util;
...
public class CartaCorrecaoUtil {
    ...
    public static String getSenhaCertificado(String cnpj) {
    ...
    public static String getCaminhoCertificado(String cnpj){
    ...
    public static String getSefazCaminhoCertificado(String cnpj) {
    ...
    public static String getTipoCertificado(String cnpj) {
    ...
    public static boolean getMultiploCertificado(String cnpj) {
