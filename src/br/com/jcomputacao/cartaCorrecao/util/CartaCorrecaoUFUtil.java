 ...
 * @author Murilo
 */
public enum CartaCorrecaoUFUtil {
    ...
    CartaCorrecaoUFUtil(int cod, String sgs, String nom) {
        this.codigo = cod;
        this.sigla = sgs;
        this.nome = nom;
    }
    ...
    public static CartaCorrecaoUFUtil porSigla(String sigla) {
        for (CartaCorrecaoUFUtil uf : CartaCorrecaoUFUtil.values()) {
    ...
    public static CartaCorrecaoUFUtil porCodigo(int codigo) {
        for (CartaCorrecaoUFUtil uf : CartaCorrecaoUFUtil.values()) {
            if (uf.codigo == codigo) {
                return uf;
            }
