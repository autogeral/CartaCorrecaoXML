...
package br.com.jcomputacao.cartaCorrecao.assinatura;
...
/**
 * Conteudo retirado e modificado de
...
public class Assinador {
    ...
    public static String assinar(String xml, String certificadoCaminho, String senha, String cnpj) throws Exception {
        ...
        KeyStore ks = null;
        if("A3".equals(CartaCorrecaoUtil.getTipoCertificado(cnpj))) {
